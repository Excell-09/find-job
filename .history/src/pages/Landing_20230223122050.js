      ...
      <header>
        <nav className='p-4 flex justify-between items-center bg-slate-800'>
          ...
          <div className='flex justify-end items-center flex-1 gap-3 whitespace-nowrap'>
            ...
            <Link className=' text-indigo-500 border-2 px-2 py-1 rounded-md border-blue-600 bg-gray-300 bg-opacity-10 hover:text-indigo-700 hover:bg-opacity-' to={'/register'}>
              Get Started
            </Link>
          </div>
        </nav>
