      ...
      <header>
        <nav className='p-4 flex justify-between items-center bg-slate-800'>
          ...
          <div className='flex justify-end items-center flex-1 gap-3 whitespace-nowrap'>
            ...
            <Link
              className=' text-indigo-700 border-2 px-2 py-1 rounded-md border-blue-600 bg-blue-300 bg-opacity-20 hover:text-indigo-700 hover:bg-opacity-90 transition-all duration-300'
              to={'/register'}>
              Get Started
            </Link>
          </div>
