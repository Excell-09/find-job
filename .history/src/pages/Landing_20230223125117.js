  ...
  return (
    <div>
      ...
      <main className='px-7 max-w-6xl mx-auto'>
        <section className='sm:min-h-screen mt-[6rem] sm:mt-0 flex justify-center items-center space-x-10 flex-wrap'>
          <article className='sm:flex-1 space-y-3 space-y-5 text-center sm:text-start'>
          ...
          <div className='sm:flex-1'>
            <img src={interviewIlustration } alt='banner' className='w-80 h-auto mx-auto' />
          </div>
        </section>
      </main>
    </div>
