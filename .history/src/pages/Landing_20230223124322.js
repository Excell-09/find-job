      ...
      <main className='px-3 max-w-6xl mx-auto'>
        <section className='min-h-screen flex justify-center items-center'>
          <article className='sm:flex-1 space-y-3'>
            ...
            <p className='text-slate-300'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit nesciunt optio, possimus corporis aspernatur ullam error explicabo quos facere magni modi consectetur amet vero cupiditate dolorem libero ea labore eligendi?</p>
