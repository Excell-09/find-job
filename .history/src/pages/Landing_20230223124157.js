    ...
    <div>
      ...
      <main className='px-3 max-w-6xl mx-auto'>
        <section className='min-h-screen flex justify-center items-center'>
          <article className='sm:flex-1 space-y-2'>
            <h1 className=' font-bold text-blue-500'>Temukan Job Impianmu Disini</h1>
            ...
            <button className='border px-2 py-1 rounded-md bg-blue-400 text-white'>Get Started</button>
          </article>
