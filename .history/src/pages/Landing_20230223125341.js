  ...
  return (
    <div>
      ...
      <main className='px-7 max-w-6xl mx-auto'>
        <section className='sm:min-h-screen mt-[6rem] sm:mt-0 flex justify-center items-center space-x-10 flex-wrap space-y-10'>
          ...
          <div className='sm:flex-1 flex justify-center ite'>
