  ...
  return (
    <div className='bg-white p-5'>
      ...
      <form className='grid grid-cols-4'>
        ...
        <SelectInput value={} changeHandle={handleChange} label='Status' option={initialStateFilter.statusOptions} name='status' />
        <SelectInput value={} changeHandle={handleChange} label='Type' option={initialStateFilter.jobTypeOptions} name='jobType' />
