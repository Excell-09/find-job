    ...
    <div className='bg-white p-5 rounded-sm shadow-lg'>
      ...
      <form className='grid grid-cols-4 gap-4'>
        ...
        <div className=' col-span-1 flex items-end gap-1'>
          <button disabled={loading} className='shadow col-span-2 smallbtn py-2' type='submit'>
            {isEditing ? 'Edit' : 'Create'}
          </button>
          <button onClick={isEditing ? () => {} : handleClear} className='shadow py-2 smallbtn bg-red-500 hover:bg-red-400' type='button'>
