  ...
  return (
    <div className='bg-white p-5 rounded-sm shadow-lg'>
      ...
      <form className='grid grid-cols-4'>
        ...
        <div className=' col flex items-end gap-1'>
          <button disabled={loading} className=' colsmallbtn py-2' type='submit'>
            {isEditing ? 'Edit' : 'Create'}
          </button>
          <button onClick={isEditing ? () => {} : handleClear} className=' py-2 smallbtn bg-red-500 hover:bg-red-400' type='button'>
