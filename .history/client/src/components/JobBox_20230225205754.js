    ...
    <div>
      ...
      <div className='mb-24 mt-5 md:my-5'>
        <div className='flex items-center justify-center md:justify-end'>
          <div className='font-bold text-center bg-white w-9 flex text-2xl items-center justify-center h-9 cursor-pointer' onClick={() => console.log('pewe pew')}>
            {'<'}
          </div>
          ...
          <div className='font-bold text-center bg-white w-9 flex text-2xl items-center justify-center h-9 cursor-pointer' onClick={() => ++page}>
            {'>'}
          </div>
        </div>
      </div>
