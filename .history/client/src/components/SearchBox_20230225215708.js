...
const SearchBox = ({ values, search, searchStatus, statusOptions, jobTypeOptions, searchType, sortOptions, sort, change }) => {
  ...
  return (
    <div className='bg-white p-5 '>
      ...
      <div className='grid grid-cols-2 grid-rows-4 md:grid-cols-3 gap-2'>
        ...
        <button onClick={handleClear} type='button' className='bg-red-500 text-white font-semibold place-self-end px-4 -y-2'>
          Clear Filter
        </button>
      </div>
    </div>
