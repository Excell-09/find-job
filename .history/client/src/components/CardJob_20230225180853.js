...
const CardJob = ({ job, ableEdit = false }) => {
  ...
  return (
    <div className='bg-white rounded-md p-3 hover:scale-110 transition-all duration-150 shadow-md'>
      <div className='flex items-center space-x-2'>
        <div className={`${} w-10 h-10 flex justify-center items-center font-black text-white`}>{company}</div>
        <div>
